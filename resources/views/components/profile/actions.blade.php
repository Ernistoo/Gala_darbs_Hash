    ...
    @if(auth()->id() === $user->id)
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open"
                ...
                x-transition
                class="absolute right-0 mt-2 w-52 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 z-10"
                :class="{ 'right-0': true, 'left-0 sm:left-auto': window.innerWidth < 640 }">
    ...
    @elseif(auth()->user()->can('delete', $user))
        <div x-data="{ open: false, deleteUserModal: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false"
                class="absolute right-0 mt-2 w-32 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-700 shadow rounded border dark:border-gray-600 z-10">
                <button type="button"
            ...
            <div x-show="deleteUserModal"
                ...
                <div @click.away="deleteUserModal = false"
                    class="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 p-6 rounded shadow w-96 max-w-[95vw]">

...
<div class="mb-6">
    ...
    <div class="drag-area flex flex-col items-center justify-center w-full h-40 border-2 border-dashed
        ...
        <div id="drag-content">
            ...
            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">PNG, JPG, GIF, WEBP up to 10MB</p>
        </div>

<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4 mb-4 space-y-2 flex items-start gap-4">
        {{-- Small thumbnail --}}
        @if($post->image)
            <img src="{{ asset($post->image) }}" alt="{{ $post->title }}" class="w-24 h-24 object-cover rounded">
        @endif

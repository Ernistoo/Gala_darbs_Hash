            ...
            <div x-show="open"
                ...
                <form action="{{ route('collections.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-2">
                    ...
                    <div class="flex justify-end gap-2 mt-2">
                        <button type="button" @click="open = false" class="px-3 py-1 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded">Cancel</button>
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden hover:scale-105 transform transition cursor-pointer"
                    ...
                    <div @click.away="editModal = false"
                        ...
                        <form action="{{ route('collections.update', $collection) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <textarea name="description"
                                class="border rounded p-2 w-full mb-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-400"
                                placeholder="Description">{{ $collection->description }}</textarea>
                            <!-- NEW: file input lai var mainīt bildi -->
                            <input type="file" name="image"
                                class="border rounded p-2 w-full mb-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                            <div class="flex justify-end gap-2">
                                <button type="button" @click="editModal = false" class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded">Cancel</button>
                ...
                <div x-show="deleteModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div @click.away="deleteModal = false"
                        ...
                        <div class="flex justify-end gap-2">
                            <button type="button" @click="deleteModal = false" class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded">Cancel</button>
